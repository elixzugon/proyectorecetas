...
//Llena el arreglo de recipes
        ...
        axios({
            method: 'get',
            url: 'https://api.spoonacular.com/recipes/complexSearch?type=main course&apiKey=25e8f453f2584685acdda482eb9fd609'
        })
            .then(
                (response) => {
    ...
    methods: {
        ...
        fillDataDetails(){
            for(let i =0; i < this.recipes.length; i++){
                axios({
                    method: 'get',
                    url: 'https://api.spoonacular.com/recipes/'+this.recipes[i].id+'/information?includeNutrition=false&apiKey=25e8f453f2584685acdda482eb9fd609'
                })
                    .then(
                        (response) => {
        ...
        onClickRecipeDetails(index) {
            ...
            axios({
                method: 'get',
                url: 'https://api.spoonacular.com/recipes/'+index+'/information?includeNutrition=false&apiKey=25e8f453f2584685acdda482eb9fd609'
            })
                .then(
                    (response) => {
        ...
        onClickSelectedCategory(category) {
                ...
                axios({
                    method: 'get',
                    url: 'https://api.spoonacular.com/recipes/complexSearch?type='+category+'&apiKey=25e8f453f2584685acdda482eb9fd609' 
                })
                    .then(
                        (response) => {
