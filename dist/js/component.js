    ...
    mounted: function () {
        this.all_recipes = this.recipes;
            ...
            axios({
                ...
                .then(
                    (response) => {
                        //this.actualUserID = response.data.user.id;
...
//_____________________________________-Axios para TOP 10-__________________________-
    ...
    */
        ...
        onSaveRecipe(index) {
            ...
            axios({
                method: 'get',
                url: 'http://prueba01.test/api/users/saverecipe/'+userId+'/'+index
            })
                .then(
                    (response) => {
                        alert("Receta guardada.")

                        console.log('Usuario: '+userId+' Id de receta: '+index);
            ...
            axios({
                ...
                .then(
                    (response) => {
                        ...
                        this.recipe.image= route+item.image;
